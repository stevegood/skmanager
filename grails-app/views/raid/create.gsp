...
<html>
	...
	<body>
		<a href="#create-raid" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-raid" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:raidInstance, action:'save']" >
				<fieldset class="form">
